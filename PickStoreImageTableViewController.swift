//
//  PickStoreImageTableViewController.swift
//  project
//
...
class PickStoreImageTableViewController: UITableViewController {
    
    
    let pickimage = ["walmart", "qualityfood", "costco","saveonfood","fruiticana", "superstore", "wholefood"]
weak var delegate: PickStoreIconVCDelegate?
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        delegate?.pickIcon(self, didPick: pickimage[indexPath.row])
    }
